...
assert f(2, 3)               == [2, 3, {}]
assert f(2, 3, a = 4)        == [2, 3, {'a' : 4}]  # must assign the key before dict packing
...
u = (2,)
assert f(y = 5, *u, **d1) == [2, 5, {'a' : 3, 'b' : 4}] # order of unpacking is x = u, y=5, then dict unpacked (repacked in the function)
